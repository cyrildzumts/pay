...
urlpatterns = [
    ...
    path('account_details/<int:uuid>/', views.account_details, name='account_details'),
    path('account/update/<int:uuid>/', views.account_update, name='update'),
    path('available_services/', views.available_services, name='available_services'),
    path('available_service_details/<int:uuid>/', views.available_service_details, name='available_service_details'),
    path('cases/', views.cases, name='cases'),
    path('cases/<int:uuid>/', views.case_details, name='case_details'),
    #path('edit_account/<int:uuid>/', views.edit_account, name='edit_account'),
    path('idcards/', views.idcards, name='idcards'),
    path('idcards/<int:uuid>/', views.idcard_details, name='idcard_details'),
    ...
    path('new_service/<int:uuid>/', views.new_service, name='new_service'),
    ...
    path('reductions/<int:uuid>/', views.reduction_details, name='reduction_details'),
    path('service_done/', views.service_done, name='service_done'),
    path('services/', views.services, name='services'),
    path('services/<int:uuid>/', views.service_details, name='service_details'),
    ...
    path('transactions/<int:uuid>/', views.transaction_details, name='transaction_details'),
    path('transfer/<int:uuid>/', views.transfer_details, name='transfer_details'),
    path('upload_idcard/', views.upload_idcard, name='upload_idcard'),
    path('idcard/update/<int:uuid>/', views.update_idcard, name='idcard_update'),
    path('upload_idcard/upload_idcard_done/', views.upload_idcard_done, name='upload_idcard_done'),
    path('payments/', views.payments, name='payments'),
    path('payment_done/', views.payment_done, name='payment_done'),
    path('payments/<int:uuid>/', views.payment_details, name='payment_details'),
    path('policies/', views.policies, name='policies'),
    path('policies/<int:uuid>/', views.policy_details, name='policy_details'),
    path('recharge/', views.recharge, name='recharge'),
    path('service_categories/', views.service_categories, name='service_categories'),
    path('service_categories/<int:uuid>/', views.service_category_details, name='service_categories_details'),
