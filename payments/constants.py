...
BALANCE_ACTIVITY_WITHDRAW = 4
BALANCE_ACTIVITY_CASHOUT = 5
BALANCE_ACTIVITY_CASHIN = 6
BALANCE_ACTIVITY_SERVICE = 7
...
BALANCE_ACTIVITY_TYPES = (
    ...
    (BALANCE_ACTIVITY_WITHDRAW, ui_strings.BALANCE_WITHDRAW_STR),
    (BALANCE_ACTIVITY_CASHOUT, ui_strings.BALANCE_CASHOUT_STR),
    (BALANCE_ACTIVITY_CASHIN, ui_strings.BALANCE_CASHIN_STR),
    (BALANCE_ACTIVITY_SERVICE, ui_strings.BALANCE_SERVICE_STR),
)



CASHOUT_TYPES = (
    (CASHOUT_WITHDRAW, ui_strings.CASHOUT_WITHDRAW_STR),
    (CASHOUT_CASHOUT, ui_strings.CASHOUT_CASHOUT_STR),
    (CASHOUT_CASHIN, ui_strings.CASHOUT_CASHIN_STR),
)